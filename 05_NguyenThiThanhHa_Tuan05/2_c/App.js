    ...
    <View style={styles.container}>
      <View style={styles.containerChild}>
        <View style={{ width: 181, height: 64 }}>
          <Text style={{color: "#fff",fontSize: 25,fontWeight: "700",textAlign: "cente"}}>
            PASSWORD GENERATOR
          </Text>
        </View>
        <View>
          <TextInput style={styles.inputDisplay} readOnly={true} value={password}/>
        </View>
        <View>
          <View style={styles.row}>
            <Text style={styles.label}>Password length</Text>
            <TextInput onChangeText={setPLength} keyboardType="numeric" style={styles.inputLength} />
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Include lower case letters </Text>
            <Checkbox uncheckedColor="#fff" color="#fff" 
        ...
        <View>
          <TouchableOpacity
            style={styles.btn}
            onPress={() =>
              generatePassword(pLength,lowercase,uppercase,number,specialSymbol) }>
