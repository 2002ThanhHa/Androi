  ...
  return (
    <View style={{flex: 1}}>
        <View style={styles.container1}>
            <Image source={image} style={{width: 112, height: 132, resizeMode: 'contain'}}></Image>
            <Text style={{ fontSize: 20, fontWeight: 400, marginTop: 17, marginLeft: 10,}}>Điện Thoại Vsmart Joy 3 Hàng chính hãng</Text>
        </View>

        <View style={styles.container2}>
            <Text style={{marginLeft: 17,marginTop: 10,fontSize: 18,fontWeight: 500}}>Chọn một màu bên dưới:</Text>
